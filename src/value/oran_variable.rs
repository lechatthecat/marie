...
impl fmt::Display for OranVariableValue<'_> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            OranVariableValue::Str(ref s) => write!(f, "{}", s.val_str.as_ref().unwrap()),
...
impl PartialEq for OranVariableValue<'_> {
    fn eq(&self, other: &OranVariableValue) -> bool {
        match *self {
            ...
            OranVariableValue::Str(ref s) => s.val_str.as_ref().unwrap().to_string() == other.to_string(),
...
impl From<OranVariableValue<'_>> for String {
    fn from(val: OranVariableValue) -> Self {
        match val {
            OranVariableValue::Str(ref s) => s.val_str.as_ref().unwrap().to_string(),
